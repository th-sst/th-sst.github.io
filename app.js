...
const EVENTS = {
    plus: [
        ...
        { id: 'dracon', title: 'ドラコン', description: 'パー5でフェアウェイ内の最長飛距離を出す', points: 2 },
...
const VEGAS_EVENTS = {
    ...
    minus: [
        ...
        { id: 'v_7chip', title: '7 Chip', description: '1ホールで「7」叩く', points: -1 },
        { id: 'v_8ball', title: '8 Ball', description: '1ホールで「8」叩く', points: -1 },
